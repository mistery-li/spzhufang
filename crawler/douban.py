...
>>>>>>> f8e28d87d4f575ddce556dd9220a81c4fdc77c7e
...
def parse_html():
    ...
    for house in house_list[1:]:
        topic = house.xpath('//td[1]/a//text()')
        author = house.xpath('//td[2]/a//text()')
        reader_resp = house.xpath('//td[3]//text()')
        time = house.xpath('//td[4]//text()')
        data_dict = {
            'topic': topic,
            'author': author,
            'reader_resp': reader_resp,
